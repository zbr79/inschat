...
export const STR: Record<UiLang, Record<string, string>> = {
  zh: {
    ...
    "settings.deleteHistory": "删除聊天记录",
    "settings.deleteHistoryHint": "清除本设备上的访客对话（保留偏好设置）",
    "settings.delete": "删除",
    "settings.deleteConfirm": "再次点击确认",
    "nav.signIn": "登录",
    "nav.guest": "访客",
    "nav.signOut": "退出登录",
    "nav.loading": "加载中…",
  ...
  en: {
    ...
    "settings.deleteHistoryHint": "Clears guest chats on this device (keeps preferences)",
    "settings.delete": "Delete",
    "settings.deleteConfirm": "Tap again to confirm",
    "nav.signIn": "Sign in",
    "nav.guest": "Guest",
