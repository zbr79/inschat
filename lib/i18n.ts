...
export const STR: Record<UiLang, Record<string, string>> = {
  zh: {
    ...
    "opencodeCalls.official": "官方配额",
    "opencodeCalls.officialSub": "来自官方 /zen/go/v1/usage 接口（Go 订阅限额按美元计）。",
    "opencodeCalls.rolling": "滚动 5 小时",
    "opencodeCalls.weekly": "每周",
    "opencodeCalls.monthly": "每月",
    "opencodeCalls.resets": "重置于",
  ...
  en: {
    ...
    "opencodeCalls.official": "Official quota",
    "opencodeCalls.officialSub": "From the official /zen/go/v1/usage endpoint (Go limits are dollar-based).",
    "opencodeCalls.rolling": "Rolling 5h",
    "opencodeCalls.weekly": "Weekly",
    "opencodeCalls.monthly": "Monthly",
    "opencodeCalls.resets": "resets",
